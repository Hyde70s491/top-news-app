...
import { SearchedNews } from "../../../selectors/news/NewsSelectorModels";
...
const SearchModal: React.FC<SearchModalProps> = (
  ...
  const searchedNews: SearchedNews[] = useSelector(selectSearchedNews);
    ...
    <div className={`search-modal${isVisible ? " search-modal--visible" : ""}`}>
      ...
      <div className="search-modal__content">
        ...
        <div className="search-modal__entities">
          {searchedNews.map((news: SearchedNews) => (
            <div
